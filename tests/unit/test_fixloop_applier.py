...
Shared scaffolding (GOOD_EDIT/BAD_EDIT/CHAR_TEST, make_plan, make_applier,
git_out) lives here; the CREATE-block / syntax-gate / accept-commit suites live
in test_fixloop_applier_create and import from here, keeping both files within
the 150-code-line limit (guidelines §3.2/§6.1).
"""
