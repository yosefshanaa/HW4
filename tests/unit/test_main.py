...
class RecordingSdk:
    ...
    def debug(self, target_path, *, agent=False):
        return self._record("debug", target_path, agent=agent)
...
class TestDispatch:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (["debug"], ("debug", (None,), {"agent": False})),
            (["debug", "case/", "--agent"], ("debug", ("case/",), {"agent": True})),
